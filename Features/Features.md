...
```
The first two set VSync (without it, the game runs at an unlimited framerate), the second one sets the anisotropic filtering and the last one sets Multi-Sample Anti-Aliasing. This requires a strong PC, of course.
